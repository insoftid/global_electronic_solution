<section class="relative">
    ...
    <div class="relative w-full" style="height: 826px;">
        ...
        @php
            $heroImage = isset($gallery['hero_portfolio']) && $gallery['hero_portfolio']->image_path
                ? asset('storage/' . $gallery['hero_portfolio']->image_path)
        ...
        <div class="relative z-10 max-w-6xl mx-auto h-full flex flex-col items-center justify-center px-6 text-center">
            <h3 class="text-white/60 font-medium text-2xl">Home <span class="text-white">/ Product & Portfolio</span>
            </h3>
            <h1
