<section class="relative">
    ...
    <div class="absolute inset-0 bg-linear-to-t from-transparent to-primary/80"></div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto h-full flex flex-col items-center justify-center px-6 text-center">
            <h3 class="text-white/60 font-medium text-2xl">Home <span class="text-white">/ Product & Portfolio</span></h3>
            ...
            <p class="mt-4 text-white/90 max-w-3xl text-xl">
                Eksplorasi koleksi lengkap proyek sistem elektrikal yang telah kami kerjakan untuk berbagai industri dan klien di Indonesia.
            </p>
        </div>
    </div>
</section>