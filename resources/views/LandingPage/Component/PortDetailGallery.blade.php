                            ...
                            <div class="shrink-0 w-full md:w-1/3 h-115">
                                <div class="h-full flex items-center justify-center">
                                    <img src="{{ asset('storage/' . $image->image_path) }}"
                                        ...
                                        class="w-full h-full object-cover hover:object-contain transition-all duration-500 rounded-lg cursor-pointer"
                                        onclick="openGalleryModal && openGalleryModal(this.src, '{{ $portfolio->title }} - Foto {{ $loop->iteration }}')" />
                                </div>
                            </div>
                        @endforeach
                    </div>
