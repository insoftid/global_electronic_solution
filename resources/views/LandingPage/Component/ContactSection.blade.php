        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center bg-primary p-6 md:p-8 lg:p-10 rounded-2xl">
            ...
            @if (session('success'))
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-4 md:space-y-6">
                    ...
                    <div>
                        <label for="name"
                            class="block text-sm md:text-base font-medium text-white mb-1">Nama</label>
                    ...
                    <div>
                        <label for="email"
                            class="block text-sm md:text-base font-medium text-white mb-1">Email</label>
                    ...
                    <div>
                        <label for="message"
                            class="block text-sm md:text-base font-medium text-white mb-1">Pesan</label>
