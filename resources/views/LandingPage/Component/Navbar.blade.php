...
<nav id="site-navbar" class="fixed bg-white/50 backdrop-blur-lg top-0 left-0 right-0 w-full z-50 transition-all">
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="flex justify-between h-16 items-center">
			...
			<div class="hidden md:flex items-center space-x-6">
				...
				<a href="/produk" class="nav-link text-md text-black hover:text-primary {{ (isset($active) && ( (is_array($active) && in_array('portofolio',$active)) || $active === 'portofolio')) ? 'active server-active' : '' }}">Produk</a>
	...
	<div class="px-4 pt-2 pb-3 flex flex-col items-start space-y-3">
			...
			<a href="/produk" class="nav-link inline-block text-md text-black hover:text-primary {{ (isset($active) && ( (is_array($active) && in_array('portofolio',$active)) || $active === 'portofolio')) ? 'active server-active' : '' }}">Portofolio</a>
