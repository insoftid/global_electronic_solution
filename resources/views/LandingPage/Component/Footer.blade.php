...
<footer class="bg-primary text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-2">
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-0">
            ...
            <div class="lg:w-1/2 items-start gap-4">
                ...
                <div>
                    <p class="mt-3 text-lg text-white max-w-md">Layanan servis elektronik profesional dengan teknologi
                        modern dan transparansi penuh untuk kepuasan pelanggan yang terbaik.</p>
                </div>
            ...
            <div class="lg:w-1/2 flex flex-col sm:flex-row justify-end gap-14">
                ...
                <div class="min-w-50">
                    ...
                    <div class="text-md text-white space-y-2 max-w-2xs">
                        ...
                        <div>Perum JL. Beringin Asri, RT 06/RW 12, Wonosari, Kec. Ngalian, Kota Semarang, Jawa Tengah,
                            50244</div>
                    </div>
                </div>
            </div>
    ...
    <div class="border-t-2 border-secondary/70 mt-8 py-6">
        <p class="text-center text-sm text-white">Designed By Insoft.id © {{ date('Y') }} CV. Global Electronic
