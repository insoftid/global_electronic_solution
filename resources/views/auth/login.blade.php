...
<body class="min-h-screen bg-gradient-to-br from-primary/10 via-white to-secondary/10">
    <style>
        ...
        @keyframes pulse-glow {
            ...
            0%,
            100% {
                box-shadow: 0 0 20px rgba(31, 118, 84, 0.3);
            }

            50% {
                box-shadow: 0 0 40px rgba(31, 118, 84, 0.5);
            }
        }
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute inset-0 opacity-5"
            style="background-image: radial-gradient(circle at 1px 1px, #1F7654 1px, transparent 0); background-size: 40px 40px;">
        </div>
    </div>
    ...
    <div class="relative min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="absolute top-6 left-6">
            <a href="/"
                class="inline-flex items-center gap-2 text-primary hover:text-primary/80 transition-colors duration-200 group">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 transform group-hover:-translate-x-1 transition-transform duration-200" fill="none"
                ...
                <a href="/" class="flex items-center gap-3 group">
                    @if(isset($settings['logo']) && $settings['logo'])
                        <img src="{{ asset('storage/' . $settings['logo']) }}"
                            ...
                            class="h-14 w-auto object-contain group-hover:scale-105 transition-all duration-300">
                    @else
                        <span
                            class="inline-flex items-center justify-center w-14 h-14 bg-primary rounded-2xl shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div
                class="login-card bg-white/80 backdrop-blur-xl py-10 px-6 shadow-2xl rounded-3xl sm:px-12 border border-white/50">
                <!-- Error Messages -->
                @if ($errors->any())
                    ...
                    <div class="input-group">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-graytext" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="input-group">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword()"
                                ...
                                <svg id="eye-open" class="h-5 w-5 hidden" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <svg id="eye-closed" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
