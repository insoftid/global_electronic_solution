		...
		<ul class="py-4 space-y-1">
			<li>
				@if(isset($active) && $active === 'dashboard')
					<a href="/admin" aria-current="page" class="flex items-center px-4 py-3 bg-[#12773a] text-white border-l-4 border-white">
				@else
			...
			<li>
				@if(isset($active) && $active === 'pengaturan')
					<a href="/admin/settings" aria-current="page" class="flex items-center px-4 py-3 bg-[#12773a] text-white border-l-4 border-white">
				@else
			...
			<li>
				@if(isset($active) && $active === 'kontak')
					<a href="/admin/contacts" aria-current="page" class="flex items-center px-4 py-3 bg-[#12773a] text-white border-l-4 border-white">
				@else
			...
			<li>
				@if(isset($active) && $active === 'adminakses')
					<a href="/admin/users" aria-current="page" class="flex items-center px-4 py-3 bg-[#12773a] text-white border-l-4 border-white">
				@else
